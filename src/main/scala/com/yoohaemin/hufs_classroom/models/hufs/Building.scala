...
object Building {
  case object MainBuilding extends Building("0", BitSet())
  case object HumanitiesBuilding extends Building("1", BitSet())
  case object TLDBuilding extends Building("2", BitSet())
  case object SocialScienceBuilding extends Building("3", BitSet())
  case object StudentHall extends Building("4", BitSet())
  case object LawSchool extends Building("5", BitSet())
  case object GraduateSchool extends Building("6", BitSet())
  case object ForeignLanguageCenter extends Building("7", BitSet())
  case object InternationalBuilding extends Building("8", BitSet())
  case object Library extends Building("9", BitSet())
  case object FacultyBuilding2 extends Building("11", BitSet())
  case object MinervaSquare extends Building("B", BitSet())
  case object CyberBuilding extends Building("C", BitSet())
  case object HistoricalArchives extends Building("역", BitSet())
